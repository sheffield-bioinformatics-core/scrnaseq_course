...
<div class="warning">
NOTE: Seurat is in the process of being upgraded from Seurat 4 to Seurat 5. This is a major package upgrade expected to be complete in **October 2023**. For the purposes of this course we will continue with Seurat 4 until Seurat 5 is fully released. For more information click [here](https://satijalab.org/seurat/articles/get_started_v5).
</div>
