...
If we take a look at the meta data we can see our new cluster/condition column
...
We can use gene databases within R to further anotate our marker genes of interest.

```{r}
#set the identitry back to the original clusters
Idents(seurat) <- "seurat_clusters"

columns(org.Hs.eg.db)
anno <- AnnotationDbi::select(org.Hs.eg.db,keys=rownames(seurat),columns=c("SYMBOL","GENENAME", "ENSEMBL"), keytype = "SYMBOL")
head(anno)  
